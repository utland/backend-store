...
export class CorrectViewTable1765531572051 implements MigrationInterface {
    name = 'CorrectViewTable1765531572051'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["VIEW","supplier_sales","public"]);
        await queryRunner.query(`DROP VIEW "supplier_sales"`);
        await queryRunner.query(`CREATE VIEW "supplier_sales" AS select 
        s.name as company_name,
